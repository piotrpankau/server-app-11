...
(function (WD) {
  ...
  const APP_ICONS = {
    ...
    games: '<svg viewBox="0 0 48 48"><rect x="3" y="14" width="42" height="24" rx="9" fill="#5a3fd6"/><circle cx="15" cy="26" r="2.6" fill="#fff"/><path d="M12 22v8M8 26h8" stroke="#fff" stroke-width="2.4" stroke-linecap="round"/><circle cx="33" cy="22" r="2.4" fill="#ffd75e"/><circle cx="38" cy="28" r="2.4" fill="#5fd07c"/><circle cx="28" cy="28" r="2.4" fill="#ff6b5e"/></svg>',
    people: '<svg viewBox="0 0 48 48"><circle cx="18" cy="17" r="7" fill="#2b88d8"/><path d="M5 39c0-7 6-12 13-12s13 5 13 12z" fill="#2b88d8"/><circle cx="34" cy="19" r="5.5" fill="#5fd07c"/><path d="M30 39c0-6 4-10 9-10s9 4 9 10z" fill="#5fd07c"/></svg>',
    sessions: '<svg viewBox="0 0 48 48"><rect x="3" y="9" width="27" height="19" rx="2.5" fill="#2b88d8"/><rect x="5.5" y="11.5" width="22" height="14" rx="1" fill="#9fd4ff"/><rect x="12" y="28" width="9" height="3" fill="#5f6b7a"/><rect x="18" y="19" width="27" height="19" rx="2.5" fill="#0e7a53"/><rect x="20.5" y="21.5" width="22" height="14" rx="1" fill="#b6ffd9"/><rect x="27" y="38" width="9" height="3" fill="#5f6b7a"/><rect x="23" y="41" width="17" height="2.5" rx="1.2" fill="#7d8896"/></svg>',
    assistant: '<svg viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="11" fill="#d97757"/><path d="M24 11c1.2 6.8 4.2 9.8 11 11-6.8 1.2-9.8 4.2-11 11-1.2-6.8-4.2-9.8-11-11 6.8-1.2 9.8-4.2 11-11z" fill="#fff"/><circle cx="34.5" cy="13.5" r="2.4" fill="#fff" opacity=".85"/></svg>',
    updates: '<svg viewBox="0 0 48 48"><circle cx="24" cy="24" r="20" fill="#0a64d6"/><path d="M33.5 17.5A11 11 0 1 0 35 26" fill="none" stroke="#fff" stroke-width="3.4" stroke-linecap="round"/><path d="M35.5 10.5v8h-8" fill="none" stroke="#fff" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
